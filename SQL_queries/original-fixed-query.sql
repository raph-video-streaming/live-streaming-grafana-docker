* | select 
  ...
  approx_distinct(case when uri like '%index.m3u8%' then regexp_extract(uri_param, 'auth_key=([^&]*)', 1) end) as "index",
  approx_distinct(case when uri like '%ll-index.m3u8%' then regexp_extract(uri_param, 'auth_key=([^&]*)', 1) end) as "ll-index",
  approx_distinct(case when uri like '%index-720p.m3u8%' then regexp_extract(uri_param, 'auth_key=([^&]*)', 1) end) as "index-720p",
